	...
	<header class="header-v2">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="New">
								<a href="/shoping-cart">Checkout</a>
							</li>
							<li>
		...
		<div class="menu-mobile">
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping-cart.html" class="label1 rs1" data-label1="hot">Checkout</a>
				</li>
			</ul>
		</div>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="{{url('public')}}/images/icons/icon-close2.png" alt="CLOSE">
				</button>
				...
				<div class="sidebar-gallery w-full p-tb-30">
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-01.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-01.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-02.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-02.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-03.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-03.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-04.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-04.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-05.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-05.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-06.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-06.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-07.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-07.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-08.jpg" data-lightbox="gallery"
							style="background-image: url('public/images/gallery-08.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="{{url('public')}}/images/gallery-09.jpg" data-lightbox="gallery"
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('public')}}/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('public')}}/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('public')}}/images/item-cart-03.jpg" alt="IMG">
						</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(public/images/slide-04.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
							<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-202 cl2 respon2">
									Shoes Store Collection 2022
								</span>
							</div>
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-01.jpg" alt="IMG-PRODUCT">
										...
										<div class="block2-txt flex-w flex-t p-t-14">
											...
											<div class="block2-txt-child2 flex-r p-t-3">
												<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
													<img class="icon-heart1 dis-block trans-04" src="{{url('public')}}/images/icons/icon-heart-01.png" alt="ICON">
													<img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{url('public')}}/images/icons/icon-heart-02.png" alt="ICON">
												</a>
											</div>
										</div>
									</div>
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-02.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-03.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-04.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-05.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-06.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-07.jpg" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{url('public')}}/images/product-08.jpg" alt="IMG-PRODUCT">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://instagram.com/naycrew.x?igshid=YmMyMTA2M2Y=" target="_blank">Nini Supiarti</a> &amp; distributed by <a href="https://instagram.com/informatika.politap?igshid=YmMyMTA2M2Y=" target="_blank">Teknik Informatika Politap</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{url('public')}}/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('public')}}/images/product-detail-01.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('public')}}/images/product-detail-01.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="{{url('public')}}/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('public')}}/images/product-detail-02.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('public')}}/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="{{url('public')}}/images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('public')}}/images/product-detail-03.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('public')}}/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
